...
import { Search, SlidersHorizontal, Layers, MapPin } from 'lucide-react'
...
export default function ExplorePage() {
  ...
  const filtered = useMemo(() => {
    ...
    return list
  }, [activeCategory, participationRange])
  return (
    <div className="min-h-full bg-bg">
      ...
      <div className="px-5 pb-3">
        <div className="flex gap-2">
          <div className="flex-1 flex items-center gap-2 bg-surface rounded-xl px-3 py-2.5 border border-border">
          ...
          <button className="w-11 h-11 bg-surface rounded-xl border border-border flex items-center justify-center">
